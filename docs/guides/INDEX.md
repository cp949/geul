...
| [`G-UI-001`](./G-UI-001-build-dismissible-overlays.md) | dismissible overlay 구현 | 바깥 클릭·Escape·keydown 처리로 닫거나 처리하는 UI 구현 |
...
| [`G-UI-004`](./G-UI-004-explain-disabled-control-reasons.md) | 비활성 컨트롤 사유 설명 | 네이티브 disabled가 hover·tab을 막아 비활성 사유를 설명하지 못하는 인터랙티브 컨트롤 구현 |
