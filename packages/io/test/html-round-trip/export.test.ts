...
describe("HTML 왕복 변환", () => {
  it("id·병합 셀·너비·헤더·색상을 왕복 변환에서 보존한다", () => {
    ...
    expect(exported.value).toBe(
      '<table data-geul-block-id="table-1" data-geul-header-rows="1" data-geul-header-columns="1"><colgroup><col data-geul-column-id="column-1" data-geul-width="160" style="width: 160px"><col data-geul-column-id="column-2" data-geul-width="240" style="width: 240px"></colgroup><thead><tr data-geul-row-id="row-1"><th data-geul-cell-id="cell-1" data-geul-column-id="column-1" rowspan="1" colspan="2" data-geul-text-color="#112233" data-geul-background-color="#AABBCC"><strong>Header</strong></th></tr></thead><tbody><tr data-geul-row-id="row-2"><th data-geul-cell-id="cell-2" data-geul-column-id="column-1" rowspan="2" colspan="1" scope="row">Row header</th><td data-geul-cell-id="cell-3" data-geul-column-id="column-2" rowspan="1" colspan="1">Body</td></tr><tr data-geul-row-id="row-3"><td data-geul-cell-id="cell-4" data-geul-column-id="column-2" rowspan="1" colspan="1"></td></tr></tbody></table>',
    );
  });
